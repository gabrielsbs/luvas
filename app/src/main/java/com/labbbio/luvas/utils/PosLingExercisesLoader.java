package com.labbbio.luvas.utils;
...
public class PosLingExercisesLoader {
    
    private static int number = 1;
    private static ArrayList<Exercise> exerciseItems = new ArrayList<>();

    public static ArrayList<Exercise> createExerciseList() {
    ...
    public static void numbersExercise() {
        ...
        for(int i = 0; i<10; i++){
            ...
            exerciseItems.add(new Exercise(number, question, answer, questionType));
            number = number + 1;
        }
    ...
    public static void lowCaseExercises() {
        String answer;
        String question;
        ...
        for (int i = 1; i <= 26; i++) {
            ...
            exerciseItems.add(new Exercise(number + i, question, answer, questionType));
        }
    ...
    public static void wordExercises1() {
        String answer;
        String question;
        String questionType;
    ...
    public static void upperCaseExercises() {
        String answer;
        String question;
        String questionType = "Emission";
        for (int i = 1; i <= 26; i++) {
    ...
    public static void wordExercises2() {
        String answer;
        String question;
        String questionType;
    ...
    public static void accentuationExercises() {
        String answer;
        String question;
        String questionType;
    ...
    public static void punctuationExercises() {
        String answer;
        String question;
        String questionType;
    ...
    public static void simbolsExercises() {
        String answer;
        String question;
        String questionType;
    ...
    public static void delimitersExercises() {
        String answer;
        String question;
        String questionType;
    ...
    public static void phrasesExercises() {
    ...
    public static void dialogExercises(){
        String answer;
        String question;
        String questionType;
    ...
    public static void textExercises(){
    ...
    public static void personalMessagesExercises(){
        String answer;
        String question;
        String questionType;
